...
void AMyProjectPawn::GetLifetimeReplicatedProps(TArray< FLifetimeProperty >& OutLifetimeProps) const
{
	...
	DOREPLIFETIME(AMyProjectPawn, Rider);
}
...
void AMyProjectPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("GetInTheCar", IE_Pressed, this, &AMyProjectPawn::GetOutTheCar);
...
void AMyProjectPawn::GetOutTheCar()
{
...
bool AMyProjectPawn::Server_SendGetOutTheCar_Validate()
{
	return true;
}
